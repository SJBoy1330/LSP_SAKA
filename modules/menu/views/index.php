						...
						<div class="toolbar" id="kt_toolbar">
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								<div  class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Menu Makanan</h1>
								</div>
							</div>
						</div>
													...
													<tr>
														...
														<td class="d-flex"> 
															...
															<div class="d-flex align-self-center justify-content-start flex-column">
																<span href="#" class="text-dark fw-bolder fs-6">Nasi Goreng</span>
															</div>
														</td>
														<td>
															<span class="text-dark fw-bolder mb-1 fs-6">100.000</span>
														</td>
														<td>
