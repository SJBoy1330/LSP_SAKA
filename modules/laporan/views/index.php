						...
						<div class="toolbar" id="kt_toolbar">
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								<div  class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Laporan Transaksi</h1>
								</div>
							</div>
						</div>
							...
							<div id="kt_content_container" class="container-xxl">
                                <div class="card mb-5 mb-xl-8">
									<div class="card-header border-0 pt-5">
                                        <div class="card-toolbar d-flex justify-content-between" style="width:100%;">
                                            <div class="d-flex">
                                                ...
                                                <div class="d-flex align-items-center position-relative ps-4 my-1" style="width: 175px;">
                                            ...
                                            <div class="d-flex text-end">
                                                <a href="#">
                                                    <img src="assets/icons/pdf.png" alt="" width="35">
                                                </a>
                                                <a href="#" class="me-5">
                                                    <img src="assets/icons/xls.png" alt="" width="35">
                                                </a>
                                                <button type="submit" class="btn btn-sm btn-danger">Tampil</button>
                                            </div>
                                        </div>
									</div>
											...
											<table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
												<thead>
													<tr class="fw-bolder text-muted border-0">
														...
														<th class="min-w-140px text-center">Nama Pembeli</th>
                                                        <th class="min-w-150px text-center">Total Pembayaran</th>
													</tr>
												</thead>
												<tbody>
													<tr>
														...
														<td class="text-center">
															<div class="d-flex justify-content-center align-items-center text-center">
																<span href="#" class="text-dark fw-bolder fs-6 text-center">1 Januari 2022</span>
															</div>
														</td>
                                                        <td class="text-center">
															<div class="d-flex justify-content-center align-items-center text-center">
																<span href="#" class="text-dark fw-bolder fs-6 text-center">Saka Dana Asmara</span>
															</div>
														</td>
														<td class="text-center">
															<div class="d-flex justify-content-center align-items-center text-center">
																<span href="#" class="text-dark fw-bolder fs-6 text-center">Rp. 1.000.000</span>
															</div>
														</td>
													</tr>
												</tbody>
